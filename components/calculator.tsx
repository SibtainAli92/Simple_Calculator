...
export default function Calculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-emerald-700 dark:bg-emerald-300">
      {/* Center the calculator within the screen */}
      <Card   className="w-full max-w-md p-6 bg-emerald-500 dark:bg-gray-800 shadow-lg rounded-lg text-center font-[math] [box-shadow:0px_0px_20px_black]">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            <Button
              variant="outline"
              className="text-2xl font-bold text-black dark:text-gray-500"
              onClick={add}
            >
              +
            </Button>
          ...
          {/* Display the result */}
          <div className="flex flex-col space-y-2">
            <Label htmlFor="result" className="text-black">Result</Label>
            <Input
              id="result"
              type="text"
              value={result}
